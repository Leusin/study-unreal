...
AABCharacterPlayer::AABCharacterPlayer()
{
	...
	static ConstructorHelpers::FObjectFinder<UInputAction> InputChangeActionControlRef(TEXT("/Script/EnhancedInput.InputAction'/Game/ArenaBattle/Input/Actions/IA_Change.IA_Change'"));
	...
	static ConstructorHelpers::FObjectFinder<UInputAction> InputActionQuaterMoveRef(TEXT("/Game/ArenaBattle/Input/Actions/IA_Quarter_Move.IA_Quarter_Move"));
...
void AABCharacterPlayer::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// 만약 EnhancedInputComponent를 사용하지 않으면 에러를 발생하도록 CastChecked 함수를 사용
